...
- 🔄 03-migrate-to-aspnet-core: Migrate project to ASP.NET Core / net10.0 ([Content](tasks/03-migrate-to-aspnet-core/task.md))
   ...
   - 🔄 03.08-fix-build: Resolve all build errors and warnings ([Content](tasks/03.08-fix-build/task.md))
